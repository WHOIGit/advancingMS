...
wDir <-  "C:/Users/Krista/Documents/Dropbox/_projects/workingWithIS/advancingMS/"
...
# or, get all spectra measured between 180 and 181 seconds:
plot.new()
sps <- my_data %>%
    filterRt(rt = c(180, 181)) %>%
    spectra
length(sps) #how many spectra?
sapply(sps,fromFile) #from which file
plot(sps[[1]]) # plot data from one spectrum
...
#Johannes Rainer posted this code for me to use on the Metabolomics Forum (10/24/2018)
#will be incorporated into XCMS > 3.3.4 and in the XCMS Vignette
# 
# This function takes an XCMSnExp object, extracts chromatograms for each feature 
#and returns it as an Chromatograms object. The Chromatograms arranges the XIC in 
#a two-dimensional matrix, columns being the individual samples. Each row contains
#the XIC for one feature. It is thus straight forward to plot the data for one 
#specific feature. 
